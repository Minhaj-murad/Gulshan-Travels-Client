        ...
        <div data-aos="fade-up" data-aos-duration="3000" >
            ...
            <div className="hero min-h-screen" style={{ backgroundImage: `url${img}` }}>
                <div className="hero-overlay bg-opacity-20 grid grid-cols-3 gap-10">
                    ...
                    <div className="card w-96 h-96 shadow-xl  image-full">
                        ...
                        <div className="card-body">
                            <h2 className="card-title  text-amber-600 font-bold text-3xl">Scuva Diving</h2>
                    ...
                    <div className="card w-96 h-96bg-base-100 shadow-xl image-full">
                        ...
                        <div className="card-body">
                            <h2 className="card-title  text-amber-600 font-bold text-3xl">Hill Hiking</h2>
                    ...
                    <div className="card w-96 h-96 bg-base-100 shadow-xl image-full">
                        ...
                        <div className="card-body">
                            <h2 className="card-title text-amber-600 font-bold text-3xl">Surfing</h2>
                    ...
                    <div className="card w-96 h-96 bg-base-100 shadow-xl image-full">
                        ...
                        <div className="card-body">
                            <h2 className="card-title  text-amber-600 font-bold text-3xl">kayaking</h2>
                    ...
                    <div className="card w-96 h-96  bg-base-100 shadow-xl image-full">
                        ...
                        <div className="card-body">
                            <h2 className="card-title  text-amber-600 font-bold text-3xl">Skateboarding</h2>
                    ...
                    <div className="card w-96 h-96  bg-base-100 shadow-xl image-full">
                        ...
                        <div className="card-body">
                            <h2 className="card-title  text-amber-600 font-bold text-3xl">Skiing</h2>
